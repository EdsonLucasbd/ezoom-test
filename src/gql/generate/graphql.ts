...
export type Carousel = Entity & Node & {
  __typename?: 'Carousel';
  component: Array<CarouselcomponentUnion>;
  /** The time the document was created */
  createdAt: Scalars['DateTime']['output'];
  /** User that created this document */
  createdBy?: Maybe<User>;
...
export type CarouselComponentArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type CarouselCreateInput = {
  component?: InputMaybe<CarouselcomponentUnionCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
};
...
export type CarouselItemData = Entity & {
  __typename?: 'CarouselItemData';
...
export type CarouselItemDataImageArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
  where?: InputMaybe<AssetSingleRelationWhereInput>;
};

export type CarouselItemDataConnectInput = {
  /** Allow to specify document position in list of connected documents, will default to appending at end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Document to connect */
  where: CarouselItemDataWhereUniqueInput;
};

/** A connection to a list of items. */
export type CarouselItemDataConnection = {
  __typename?: 'CarouselItemDataConnection';
  aggregate: Aggregate;
  /** A list of edges. */
  edges: Array<CarouselItemDataEdge>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

export type CarouselItemDataCreateInput = {
...
export type CarouselItemDataCreateManyInlineInput = {
  /** Create and connect multiple existing CarouselItemData documents */
  create?: InputMaybe<Array<CarouselItemDataCreateInput>>;
};

export type CarouselItemDataCreateOneInlineInput = {
  /** Create and connect one CarouselItemData document */
  create?: InputMaybe<CarouselItemDataCreateInput>;
};

export type CarouselItemDataCreateWithPositionInput = {
  /** Document to create */
  data: CarouselItemDataCreateInput;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
};

/** An edge in a connection. */
export type CarouselItemDataEdge = {
  __typename?: 'CarouselItemDataEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: CarouselItemData;
};

/** Identifies documents */
export type CarouselItemDataManyWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<CarouselItemDataWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<CarouselItemDataWhereInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<CarouselItemDataWhereInput>>;
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']['input']>;
  color?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
...
export enum CarouselItemDataOrderByInput {
  ColorAsc = 'color_ASC',
...
export type CarouselItemDataParent = Carousel | Section;

export type CarouselItemDataParentConnectInput = {
  Carousel?: InputMaybe<CarouselConnectInput>;
  Section?: InputMaybe<SectionConnectInput>;
};

export type CarouselItemDataParentCreateInput = {
  Carousel?: InputMaybe<CarouselCreateInput>;
  Section?: InputMaybe<SectionCreateInput>;
};

export type CarouselItemDataParentCreateManyInlineInput = {
  /** Connect multiple existing CarouselItemDataParent documents */
  connect?: InputMaybe<Array<CarouselItemDataParentWhereUniqueInput>>;
  /** Create and connect multiple existing CarouselItemDataParent documents */
  create?: InputMaybe<Array<CarouselItemDataParentCreateInput>>;
};

export type CarouselItemDataParentCreateOneInlineInput = {
  /** Connect one existing CarouselItemDataParent document */
  connect?: InputMaybe<CarouselItemDataParentWhereUniqueInput>;
  /** Create and connect one CarouselItemDataParent document */
  create?: InputMaybe<CarouselItemDataParentCreateInput>;
};

export type CarouselItemDataParentUpdateInput = {
  Carousel?: InputMaybe<CarouselUpdateInput>;
  Section?: InputMaybe<SectionUpdateInput>;
};

export type CarouselItemDataParentUpdateManyInlineInput = {
  /** Connect multiple existing CarouselItemDataParent documents */
  connect?: InputMaybe<Array<CarouselItemDataParentConnectInput>>;
  /** Create and connect multiple CarouselItemDataParent documents */
  create?: InputMaybe<Array<CarouselItemDataParentCreateInput>>;
  /** Delete multiple CarouselItemDataParent documents */
  delete?: InputMaybe<Array<CarouselItemDataParentWhereUniqueInput>>;
  /** Disconnect multiple CarouselItemDataParent documents */
  disconnect?: InputMaybe<Array<CarouselItemDataParentWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing CarouselItemDataParent documents */
  set?: InputMaybe<Array<CarouselItemDataParentWhereUniqueInput>>;
  /** Update multiple CarouselItemDataParent documents */
  update?: InputMaybe<Array<CarouselItemDataParentUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple CarouselItemDataParent documents */
  upsert?: InputMaybe<Array<CarouselItemDataParentUpsertWithNestedWhereUniqueInput>>;
};

export type CarouselItemDataParentUpdateManyWithNestedWhereInput = {
  Carousel?: InputMaybe<CarouselUpdateManyWithNestedWhereInput>;
  Section?: InputMaybe<SectionUpdateManyWithNestedWhereInput>;
};

export type CarouselItemDataParentUpdateOneInlineInput = {
  /** Connect existing CarouselItemDataParent document */
  connect?: InputMaybe<CarouselItemDataParentWhereUniqueInput>;
  /** Create and connect one CarouselItemDataParent document */
  create?: InputMaybe<CarouselItemDataParentCreateInput>;
  /** Delete currently connected CarouselItemDataParent document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Disconnect currently connected CarouselItemDataParent document */
  disconnect?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single CarouselItemDataParent document */
  update?: InputMaybe<CarouselItemDataParentUpdateWithNestedWhereUniqueInput>;
  /** Upsert single CarouselItemDataParent document */
  upsert?: InputMaybe<CarouselItemDataParentUpsertWithNestedWhereUniqueInput>;
};

export type CarouselItemDataParentUpdateWithNestedWhereUniqueInput = {
  Carousel?: InputMaybe<CarouselUpdateWithNestedWhereUniqueInput>;
  Section?: InputMaybe<SectionUpdateWithNestedWhereUniqueInput>;
};

export type CarouselItemDataParentUpsertWithNestedWhereUniqueInput = {
  Carousel?: InputMaybe<CarouselUpsertWithNestedWhereUniqueInput>;
  Section?: InputMaybe<SectionUpsertWithNestedWhereUniqueInput>;
};

export type CarouselItemDataParentWhereInput = {
  Carousel?: InputMaybe<CarouselWhereInput>;
  Section?: InputMaybe<SectionWhereInput>;
};

export type CarouselItemDataParentWhereUniqueInput = {
  Carousel?: InputMaybe<CarouselWhereUniqueInput>;
  Section?: InputMaybe<SectionWhereUniqueInput>;
};

export type CarouselItemDataUpdateInput = {
  color?: InputMaybe<Scalars['String']['input']>;
  date?: InputMaybe<Scalars['String']['input']>;
...
export type CarouselItemDataUpdateManyInlineInput = {
  /** Create and connect multiple CarouselItemData component instances */
  create?: InputMaybe<Array<CarouselItemDataCreateWithPositionInput>>;
  /** Delete multiple CarouselItemData documents */
  delete?: InputMaybe<Array<CarouselItemDataWhereUniqueInput>>;
  /** Update multiple CarouselItemData component instances */
  update?: InputMaybe<Array<CarouselItemDataUpdateWithNestedWhereUniqueAndPositionInput>>;
  /** Upsert multiple CarouselItemData component instances */
  upsert?: InputMaybe<Array<CarouselItemDataUpsertWithNestedWhereUniqueAndPositionInput>>;
};

export type CarouselItemDataUpdateManyInput = {
  color?: InputMaybe<Scalars['String']['input']>;
  date?: InputMaybe<Scalars['String']['input']>;
  title?: InputMaybe<Scalars['String']['input']>;
};

export type CarouselItemDataUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: CarouselItemDataUpdateManyInput;
  /** Document search */
  where: CarouselItemDataWhereInput;
};

export type CarouselItemDataUpdateOneInlineInput = {
  /** Create and connect one CarouselItemData document */
  create?: InputMaybe<CarouselItemDataCreateInput>;
  /** Delete currently connected CarouselItemData document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single CarouselItemData document */
  update?: InputMaybe<CarouselItemDataUpdateWithNestedWhereUniqueInput>;
  /** Upsert single CarouselItemData document */
  upsert?: InputMaybe<CarouselItemDataUpsertWithNestedWhereUniqueInput>;
};

export type CarouselItemDataUpdateWithNestedWhereUniqueAndPositionInput = {
  /** Document to update */
  data?: InputMaybe<CarouselItemDataUpdateInput>;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
...
export type CarouselItemDataUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
  data: CarouselItemDataUpdateInput;
  /** Unique document search */
  where: CarouselItemDataWhereUniqueInput;
};

export type CarouselItemDataUpsertInput = {
  /** Create document if it didn't exist */
  create: CarouselItemDataCreateInput;
  /** Update document if it exists */
  update: CarouselItemDataUpdateInput;
};

export type CarouselItemDataUpsertWithNestedWhereUniqueAndPositionInput = {
  /** Document to upsert */
  data?: InputMaybe<CarouselItemDataUpsertInput>;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Unique component instance search */
  where: CarouselItemDataWhereUniqueInput;
...
export type CarouselItemDataUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: CarouselItemDataUpsertInput;
  /** Unique document search */
  where: CarouselItemDataWhereUniqueInput;
};

/** Identifies documents */
export type CarouselItemDataWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<CarouselItemDataWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<CarouselItemDataWhereInput>>;
...
/** References CarouselItemData record uniquely */
export type CarouselItemDataWhereUniqueInput = {
  id?: InputMaybe<Scalars['ID']['input']>;
};
...
export type CarouselManyWhereInput = {
  ...
  component_some?: InputMaybe<CarouselcomponentUnionWhereInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
...
export type CarouselUpdateInput = {
  component?: InputMaybe<CarouselcomponentUnionUpdateManyInlineInput>;
};
...
export type CarouselcomponentUnion = CarouselItemData;

export type CarouselcomponentUnionConnectInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataConnectInput>;
};

export type CarouselcomponentUnionCreateInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataCreateInput>;
};

export type CarouselcomponentUnionCreateManyInlineInput = {
  /** Create and connect multiple existing CarouselcomponentUnion documents */
  create?: InputMaybe<Array<CarouselcomponentUnionCreateInput>>;
};

export type CarouselcomponentUnionCreateOneInlineInput = {
  /** Create and connect one CarouselcomponentUnion document */
  create?: InputMaybe<CarouselcomponentUnionCreateInput>;
};

export type CarouselcomponentUnionCreateWithPositionInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataCreateWithPositionInput>;
};

export type CarouselcomponentUnionUpdateInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpdateInput>;
};

export type CarouselcomponentUnionUpdateManyInlineInput = {
  /** Create and connect multiple CarouselcomponentUnion component instances */
  create?: InputMaybe<Array<CarouselcomponentUnionCreateWithPositionInput>>;
  /** Delete multiple CarouselcomponentUnion documents */
  delete?: InputMaybe<Array<CarouselcomponentUnionWhereUniqueInput>>;
  /** Update multiple CarouselcomponentUnion component instances */
  update?: InputMaybe<Array<CarouselcomponentUnionUpdateWithNestedWhereUniqueAndPositionInput>>;
  /** Upsert multiple CarouselcomponentUnion component instances */
  upsert?: InputMaybe<Array<CarouselcomponentUnionUpsertWithNestedWhereUniqueAndPositionInput>>;
};

export type CarouselcomponentUnionUpdateManyWithNestedWhereInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpdateManyWithNestedWhereInput>;
};

export type CarouselcomponentUnionUpdateOneInlineInput = {
  /** Create and connect one CarouselcomponentUnion document */
  create?: InputMaybe<CarouselcomponentUnionCreateInput>;
  /** Delete currently connected CarouselcomponentUnion document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single CarouselcomponentUnion document */
  update?: InputMaybe<CarouselcomponentUnionUpdateWithNestedWhereUniqueInput>;
  /** Upsert single CarouselcomponentUnion document */
  upsert?: InputMaybe<CarouselcomponentUnionUpsertWithNestedWhereUniqueInput>;
};

export type CarouselcomponentUnionUpdateWithNestedWhereUniqueAndPositionInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpdateWithNestedWhereUniqueAndPositionInput>;
};

export type CarouselcomponentUnionUpdateWithNestedWhereUniqueInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpdateWithNestedWhereUniqueInput>;
};

export type CarouselcomponentUnionUpsertWithNestedWhereUniqueAndPositionInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpsertWithNestedWhereUniqueAndPositionInput>;
};

export type CarouselcomponentUnionUpsertWithNestedWhereUniqueInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpsertWithNestedWhereUniqueInput>;
};

export type CarouselcomponentUnionWhereInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataWhereInput>;
};

export type CarouselcomponentUnionWhereUniqueInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataWhereUniqueInput>;
};
...
export type Hero = Entity & Node & {
  ...
  /** User that last updated this document */
  updatedBy?: Maybe<User>;
  whatsapp?: Maybe<Social>;
};


export type HeroBgImageArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
  where?: InputMaybe<AssetSingleRelationWhereInput>;
};
...
export type HeroCreateInput = {
  ...
  title?: InputMaybe<Scalars['String']['input']>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
  whatsapp?: InputMaybe<SocialCreateOneInlineInput>;
};
...
export type HeroManyWhereInput = {
  ...
  updatedAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']['input']>>>;
  updatedBy?: InputMaybe<UserWhereInput>;
  whatsapp?: InputMaybe<SocialWhereInput>;
};
...
export type Menu = Entity & Node & {
  ...
  publishedBy?: Maybe<User>;
  scheduledIn: Array<ScheduledOperation>;
  socialLink: Array<MenusocialLinkUnion>;
  /** System stage field */
  stage: Stage;
  /** The time the document was updated */
  updatedAt: Scalars['DateTime']['output'];
...
export type MenuSocialLinkArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type MenuManyWhereInput = {
  ...
  /** Matches if the modular component contains at least one connection to the item provided to the filter */
  menuLink_some?: InputMaybe<MenumenuLinkUnionWhereInput>;
  publishedAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
  ...
  scheduledIn_some?: InputMaybe<ScheduledOperationWhereInput>;
  /** All values in which the union is empty. */
  socialLink_empty?: InputMaybe<Scalars['Boolean']['input']>;
  /** Matches if the modular component contains at least one connection to the item provided to the filter */
  socialLink_some?: InputMaybe<MenusocialLinkUnionWhereInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
...
export type MenumenuLinkUnion = Link;

export type MenumenuLinkUnionConnectInput = {
  Link?: InputMaybe<LinkConnectInput>;
};

export type MenumenuLinkUnionCreateInput = {
  Link?: InputMaybe<LinkCreateInput>;
};

export type MenumenuLinkUnionCreateManyInlineInput = {
  /** Create and connect multiple existing MenumenuLinkUnion documents */
  create?: InputMaybe<Array<MenumenuLinkUnionCreateInput>>;
};

export type MenumenuLinkUnionCreateOneInlineInput = {
  /** Create and connect one MenumenuLinkUnion document */
  create?: InputMaybe<MenumenuLinkUnionCreateInput>;
};

export type MenumenuLinkUnionCreateWithPositionInput = {
  Link?: InputMaybe<LinkCreateWithPositionInput>;
};

export type MenumenuLinkUnionUpdateInput = {
  Link?: InputMaybe<LinkUpdateInput>;
};

export type MenumenuLinkUnionUpdateManyInlineInput = {
  /** Create and connect multiple MenumenuLinkUnion component instances */
  create?: InputMaybe<Array<MenumenuLinkUnionCreateWithPositionInput>>;
  /** Delete multiple MenumenuLinkUnion documents */
  delete?: InputMaybe<Array<MenumenuLinkUnionWhereUniqueInput>>;
  /** Update multiple MenumenuLinkUnion component instances */
  update?: InputMaybe<Array<MenumenuLinkUnionUpdateWithNestedWhereUniqueAndPositionInput>>;
  /** Upsert multiple MenumenuLinkUnion component instances */
  upsert?: InputMaybe<Array<MenumenuLinkUnionUpsertWithNestedWhereUniqueAndPositionInput>>;
};

export type MenumenuLinkUnionUpdateManyWithNestedWhereInput = {
  Link?: InputMaybe<LinkUpdateManyWithNestedWhereInput>;
};

export type MenumenuLinkUnionUpdateOneInlineInput = {
  /** Create and connect one MenumenuLinkUnion document */
  create?: InputMaybe<MenumenuLinkUnionCreateInput>;
  /** Delete currently connected MenumenuLinkUnion document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single MenumenuLinkUnion document */
  update?: InputMaybe<MenumenuLinkUnionUpdateWithNestedWhereUniqueInput>;
  /** Upsert single MenumenuLinkUnion document */
  upsert?: InputMaybe<MenumenuLinkUnionUpsertWithNestedWhereUniqueInput>;
};

export type MenumenuLinkUnionUpdateWithNestedWhereUniqueAndPositionInput = {
  Link?: InputMaybe<LinkUpdateWithNestedWhereUniqueAndPositionInput>;
};

export type MenumenuLinkUnionUpdateWithNestedWhereUniqueInput = {
  Link?: InputMaybe<LinkUpdateWithNestedWhereUniqueInput>;
};

export type MenumenuLinkUnionUpsertWithNestedWhereUniqueAndPositionInput = {
  Link?: InputMaybe<LinkUpsertWithNestedWhereUniqueAndPositionInput>;
};

export type MenumenuLinkUnionUpsertWithNestedWhereUniqueInput = {
  Link?: InputMaybe<LinkUpsertWithNestedWhereUniqueInput>;
};

export type MenumenuLinkUnionWhereInput = {
  Link?: InputMaybe<LinkWhereInput>;
};

export type MenumenuLinkUnionWhereUniqueInput = {
  Link?: InputMaybe<LinkWhereUniqueInput>;
};

export type MenusocialLinkUnion = Social;

export type MenusocialLinkUnionConnectInput = {
  Social?: InputMaybe<SocialConnectInput>;
};

export type MenusocialLinkUnionCreateInput = {
  Social?: InputMaybe<SocialCreateInput>;
};

export type MenusocialLinkUnionCreateManyInlineInput = {
  /** Create and connect multiple existing MenusocialLinkUnion documents */
  create?: InputMaybe<Array<MenusocialLinkUnionCreateInput>>;
};

export type MenusocialLinkUnionCreateOneInlineInput = {
  /** Create and connect one MenusocialLinkUnion document */
  create?: InputMaybe<MenusocialLinkUnionCreateInput>;
};

export type MenusocialLinkUnionCreateWithPositionInput = {
  Social?: InputMaybe<SocialCreateWithPositionInput>;
};

export type MenusocialLinkUnionUpdateInput = {
  Social?: InputMaybe<SocialUpdateInput>;
};

export type MenusocialLinkUnionUpdateManyInlineInput = {
  /** Create and connect multiple MenusocialLinkUnion component instances */
  create?: InputMaybe<Array<MenusocialLinkUnionCreateWithPositionInput>>;
  /** Delete multiple MenusocialLinkUnion documents */
  delete?: InputMaybe<Array<MenusocialLinkUnionWhereUniqueInput>>;
  /** Update multiple MenusocialLinkUnion component instances */
  update?: InputMaybe<Array<MenusocialLinkUnionUpdateWithNestedWhereUniqueAndPositionInput>>;
  /** Upsert multiple MenusocialLinkUnion component instances */
  upsert?: InputMaybe<Array<MenusocialLinkUnionUpsertWithNestedWhereUniqueAndPositionInput>>;
};

export type MenusocialLinkUnionUpdateManyWithNestedWhereInput = {
  Social?: InputMaybe<SocialUpdateManyWithNestedWhereInput>;
};

export type MenusocialLinkUnionUpdateOneInlineInput = {
  /** Create and connect one MenusocialLinkUnion document */
  create?: InputMaybe<MenusocialLinkUnionCreateInput>;
  /** Delete currently connected MenusocialLinkUnion document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single MenusocialLinkUnion document */
  update?: InputMaybe<MenusocialLinkUnionUpdateWithNestedWhereUniqueInput>;
  /** Upsert single MenusocialLinkUnion document */
  upsert?: InputMaybe<MenusocialLinkUnionUpsertWithNestedWhereUniqueInput>;
};

export type MenusocialLinkUnionUpdateWithNestedWhereUniqueAndPositionInput = {
  Social?: InputMaybe<SocialUpdateWithNestedWhereUniqueAndPositionInput>;
};

export type MenusocialLinkUnionUpdateWithNestedWhereUniqueInput = {
  Social?: InputMaybe<SocialUpdateWithNestedWhereUniqueInput>;
};

export type MenusocialLinkUnionUpsertWithNestedWhereUniqueAndPositionInput = {
  Social?: InputMaybe<SocialUpsertWithNestedWhereUniqueAndPositionInput>;
};

export type MenusocialLinkUnionUpsertWithNestedWhereUniqueInput = {
  Social?: InputMaybe<SocialUpsertWithNestedWhereUniqueInput>;
};

export type MenusocialLinkUnionWhereInput = {
  Social?: InputMaybe<SocialWhereInput>;
};

export type MenusocialLinkUnionWhereUniqueInput = {
  Social?: InputMaybe<SocialWhereUniqueInput>;
};
...
export type ScheduledOperationAffectedDocument = Asset | Carousel | Hero | Menu | Section;
...
export type Section = Entity & Node & {
  ...
  publishedBy?: Maybe<User>;
  scheduledIn: Array<ScheduledOperation>;
  sectionItem: Array<SectionsectionItemUnion>;
...
export type SectionSectionItemArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type SectionCreateInput = {
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  sectionItem?: InputMaybe<SectionsectionItemUnionCreateManyInlineInput>;
...
export type SectionManyWhereInput = {
  ...
  scheduledIn_some?: InputMaybe<ScheduledOperationWhereInput>;
  /** All values in which the union is empty. */
  sectionItem_empty?: InputMaybe<Scalars['Boolean']['input']>;
  /** Matches if the modular component contains at least one connection to the item provided to the filter */
  sectionItem_some?: InputMaybe<SectionsectionItemUnionWhereInput>;
  sectionSubTitle?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  sectionSubTitle_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
  sectionSubTitle_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  sectionSubTitle_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  sectionSubTitle_not?: InputMaybe<Scalars['String']['input']>;
  /** All values not containing the given string. */
  sectionSubTitle_not_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values not ending with the given string */
  sectionSubTitle_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  sectionSubTitle_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  sectionSubTitle_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  sectionSubTitle_starts_with?: InputMaybe<Scalars['String']['input']>;
  title?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  title_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
...
export enum SectionOrderByInput {
  ...
  PublishedAtAsc = 'publishedAt_ASC',
  PublishedAtDesc = 'publishedAt_DESC',
  SectionSubTitleAsc = 'sectionSubTitle_ASC',
  SectionSubTitleDesc = 'sectionSubTitle_DESC',
  TitleAsc = 'title_ASC',
  TitleDesc = 'title_DESC',
  UpdatedAtAsc = 'updatedAt_ASC',
  UpdatedAtDesc = 'updatedAt_DESC'
...
export type SectionUpdateInput = {
  sectionItem?: InputMaybe<SectionsectionItemUnionUpdateManyInlineInput>;
  sectionSubTitle?: InputMaybe<Scalars['String']['input']>;
  title?: InputMaybe<Scalars['String']['input']>;
};
...
export type SectionsectionItemUnion = CarouselItemData;

export type SectionsectionItemUnionConnectInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataConnectInput>;
};

export type SectionsectionItemUnionCreateInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataCreateInput>;
};

export type SectionsectionItemUnionCreateManyInlineInput = {
  /** Create and connect multiple existing SectionsectionItemUnion documents */
  create?: InputMaybe<Array<SectionsectionItemUnionCreateInput>>;
};

export type SectionsectionItemUnionCreateOneInlineInput = {
  /** Create and connect one SectionsectionItemUnion document */
  create?: InputMaybe<SectionsectionItemUnionCreateInput>;
};

export type SectionsectionItemUnionCreateWithPositionInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataCreateWithPositionInput>;
};

export type SectionsectionItemUnionUpdateInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpdateInput>;
};

export type SectionsectionItemUnionUpdateManyInlineInput = {
  /** Create and connect multiple SectionsectionItemUnion component instances */
  create?: InputMaybe<Array<SectionsectionItemUnionCreateWithPositionInput>>;
  /** Delete multiple SectionsectionItemUnion documents */
  delete?: InputMaybe<Array<SectionsectionItemUnionWhereUniqueInput>>;
  /** Update multiple SectionsectionItemUnion component instances */
  update?: InputMaybe<Array<SectionsectionItemUnionUpdateWithNestedWhereUniqueAndPositionInput>>;
  /** Upsert multiple SectionsectionItemUnion component instances */
  upsert?: InputMaybe<Array<SectionsectionItemUnionUpsertWithNestedWhereUniqueAndPositionInput>>;
};

export type SectionsectionItemUnionUpdateManyWithNestedWhereInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpdateManyWithNestedWhereInput>;
};

export type SectionsectionItemUnionUpdateOneInlineInput = {
  /** Create and connect one SectionsectionItemUnion document */
  create?: InputMaybe<SectionsectionItemUnionCreateInput>;
  /** Delete currently connected SectionsectionItemUnion document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single SectionsectionItemUnion document */
  update?: InputMaybe<SectionsectionItemUnionUpdateWithNestedWhereUniqueInput>;
  /** Upsert single SectionsectionItemUnion document */
  upsert?: InputMaybe<SectionsectionItemUnionUpsertWithNestedWhereUniqueInput>;
};

export type SectionsectionItemUnionUpdateWithNestedWhereUniqueAndPositionInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpdateWithNestedWhereUniqueAndPositionInput>;
};

export type SectionsectionItemUnionUpdateWithNestedWhereUniqueInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpdateWithNestedWhereUniqueInput>;
};

export type SectionsectionItemUnionUpsertWithNestedWhereUniqueAndPositionInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpsertWithNestedWhereUniqueAndPositionInput>;
};

export type SectionsectionItemUnionUpsertWithNestedWhereUniqueInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataUpsertWithNestedWhereUniqueInput>;
};

export type SectionsectionItemUnionWhereInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataWhereInput>;
};

export type SectionsectionItemUnionWhereUniqueInput = {
  CarouselItemData?: InputMaybe<CarouselItemDataWhereUniqueInput>;
};
...
export type SocialParent = Hero | Menu;
...
export type MyQueryQuery = { __typename?: 'Query', menu?: { __typename?: 'Menu', logo?: { __typename?: 'Asset', url: string } | null, menuLink: Array<{ __typename?: 'Link', id: string, title?: string | null }>, socialLink: Array<{ __typename?: 'Social', id: string, name?: string | null, icon?: { __typename?: 'Asset', url: string } | null }> } | null, hero?: { __typename?: 'Hero', title?: string | null, subTitle?: string | null, bgImage?: { __typename?: 'Asset', url: string } | null, whatsapp?: { __typename?: 'Social', icon?: { __typename?: 'Asset', url: string } | null } | null } | null, carousel?: { __typename?: 'Carousel', component: Array<{ __typename?: 'CarouselItemData', id: string, title?: string | null, date?: string | null, color?: string | null, image?: { __typename?: 'Asset', url: string } | null }> } | null, sections: Array<{ __typename?: 'Section', title?: string | null, id: string, sectionSubTitle?: string | null, sectionItem: Array<{ __typename?: 'CarouselItemData', id: string, title?: string | null, date?: string | null, image?: { __typename?: 'Asset', url: string } | null }> }> };
